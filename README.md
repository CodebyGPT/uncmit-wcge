...
:: 或手动下载后右键 → 以管理员身份运行
curl.exe -LO https://raw.githubusercontent.com/CodebyGPT/uncmit-wcge/master/src/uncmit-cleanup.cmd
uncmit-cleanup.cmd
```
