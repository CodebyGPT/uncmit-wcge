...
| `scr/uncmit-cleanup.ps1` | 后期清理脚本（可选）：首次登录后以管理员身份运行，清除惰性 CMIT 载荷 |
...
irm https://raw.githubusercontent.com/CodebyGPT/uncmit-wcge/master/scr/uncmit-cleanup.ps1 | iex
```
