...
#CMGEInstaller
# UNCMIT-DISABLED Start-Process -FilePath "$env:SystemDrive\Recovery\OEM\CMGE\ResetSources\EPrivilege.exe" -ArgumentList " -U:S $env:SystemDrive\Recovery\OEM\CMGE\ResetSources\CMGEInstaller\CMGEInstaller.exe 01000000" -WindowStyle Hidden -Wait
...
# UNCMIT-DISABLED $SMxExe="$env:SystemDrive\Recovery\OEM\CMGE\ResetSources\CMITSMx\win32\WstSM2ECESConfig.exe"
...
# UNCMIT-DISABLED $SMxExe="$env:SystemDrive\Recovery\OEM\CMGE\ResetSources\CMITSMx\win32\WstSM2ECDSAConfig.exe"
# UNCMIT-DISABLED $SMxCfg="-register"
# UNCMIT-DISABLED Start-Process -WindowStyle Hidden -FilePath "$SMxExe" -ArgumentList "$SMxCfg" -Verb runas -Wait
# UNCMIT-DISABLED $SMxExe="$env:SystemDrive\Recovery\OEM\CMGE\ResetSources\CMITSMx\win32\WstKSPConfig.exe"
# UNCMIT-DISABLED $SMxCfg="-register"
# UNCMIT-DISABLED Start-Process -WindowStyle Hidden -FilePath "$SMxExe" -ArgumentList "$SMxCfg" -Verb runas -Wait
# UNCMIT-DISABLED $SMxExe="$env:SystemDrive\Recovery\OEM\CMGE\ResetSources\CMITSMx\win32\WstSM3Config.exe"
# UNCMIT-DISABLED $SMxCfg="-register"
# UNCMIT-DISABLED Start-Process -WindowStyle Hidden -FilePath "$SMxExe" -ArgumentList "$SMxCfg" -Verb runas -Wait
# UNCMIT-DISABLED $SMxExe="$env:SystemDrive\Recovery\OEM\CMGE\ResetSources\CMITSMx\win32\WstSM4Config.exe"
# UNCMIT-DISABLED $SMxCfg="-register"
# UNCMIT-DISABLED Start-Process -WindowStyle Hidden -FilePath "$SMxExe" -ArgumentList "$SMxCfg" -Verb runas -Wait
# UNCMIT-DISABLED $SMxExe="$env:SystemDrive\Recovery\OEM\CMGE\ResetSources\CMITSMx\win32\WstRngConfig.exe"
# UNCMIT-DISABLED $SMxCfg="-register"
# UNCMIT-DISABLED Start-Process -WindowStyle Hidden -FilePath "$SMxExe" -ArgumentList "$SMxCfg" -Verb runas -Wait
# UNCMIT-DISABLED $SMxExe="$env:SystemDrive\Recovery\OEM\CMGE\ResetSources\CMITSMx\win32\WstKSPConfig.exe"
