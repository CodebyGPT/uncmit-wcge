...
# UNCMIT-DISABLED Copy-Item "$env:SystemDrive\Recovery\OEM\CMGE\ResetSources\CMITSMx\win64\msvcr110.dll" "$env:windir\System32\" -Force
# UNCMIT-DISABLED Copy-Item "$env:SystemDrive\Recovery\OEM\CMGE\ResetSources\CMITSMx\win64\msvcr110d.dll" "$env:windir\System32\" -Force
# UNCMIT-DISABLED Copy-Item "$env:SystemDrive\Recovery\OEM\CMGE\ResetSources\CMITSMx\win32\msvcr110.dll" "$env:windir\SysWOW64\" -Force
# UNCMIT-DISABLED Copy-Item "$env:SystemDrive\Recovery\OEM\CMGE\ResetSources\CMITSMx\win32\msvcr110d.dll" "$env:windir\SysWOW64\" -Force

#CMITCMGEInstaller
# UNCMIT-DISABLED Start-Process -FilePath "$env:SystemDrive\Recovery\OEM\CMGE\ResetSources\EPrivilege.exe" -ArgumentList " -U:S $env:SystemDrive\Recovery\OEM\CMGE\ResetSources\CMGEInstaller\CMGEInstaller.exe 00000400" -WindowStyle Hidden -Wait
